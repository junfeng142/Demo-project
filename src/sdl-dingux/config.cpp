...
void ConfigGameDefault()
{
	...
	keymap.left = SDLK_l;
	keymap.right = SDLK_r;
	keymap.fire1 = SDLK_a;	// A
	keymap.fire2 = SDLK_b;	// B
	keymap.fire3 = SDLK_x;	// X
	keymap.fire4 = SDLK_y;	// Y
	keymap.fire5 = SDLK_m;	// L
	keymap.fire6 = SDLK_n;	// R
	keymap.coin1 = SDLK_k;	// SELECT
	keymap.start1 = SDLK_s;	// START
	keymap.pause = SDLK_p;
	keymap.quit = SDLK_e;
	keymap.qsave = SDLK_i;		// quick save
	keymap.qload = SDLK_j;		// quick load
