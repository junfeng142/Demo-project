...
void Keyboard::saveP() {
    ofstream f("/mnt/FunKey/.zelda-roth/system.dat",ios::out | ios::binary);
...
void Keyboard::loadP() {
    ifstream f("/mnt/FunKey/.zelda-roth/system.dat",ios::in | ios::binary);
    if(!f.is_open()) return;
