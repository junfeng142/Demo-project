...
#ifdef DINGUX
#define SDLK_z  32 //Y shoot, keep down in order to run
#define SDLK_x  308 //A jump
#define SDLK_c  306 //B use your whip
#define SDLK_F5 9 //L quicksave (1 slot)
#define SDLK_F7 8 //R quickload
#define SDLK_SPACE 304 //X speed throttle
#endif

static char *VERSION = "1.2.4";

static char *QUICKSAVE_FILENAME = "/mnt/FunKey/.hota/quicksave";
static char *RECORDED_KEYS_FILENAME = "/mnt/FunKey/.hota/recorded-keys";
...
#endif
		if (Mix_OpenAudio(22050, AUDIO_S16, 2, MIX_BUFFER_SIZE) < 0)
		{
